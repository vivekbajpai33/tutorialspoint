...
urlpatterns = [
    ...
    path(r'cours/api/', CoursesApiView.as_view(), name='addcourses'),
    ...
    path('delete-blog/<int:id>/', deleteblog, name='dblog'),
    # reset password url
    ...
    path('edit-notification/<int:id>/', editnotify, name='editnotify'),
    path('delete-notification/<int:id>/', deletenotify, name='editnotify'),
]
